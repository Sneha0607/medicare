...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      {<img style={{ display: 'none' }} src={process.env.PUBLIC_URL + 'images/home.jpg'} alt='Medicare' />}
      <Box
        sx={{
          position: 'absolute',
          top: 0,
        ...
        <Grid item md={6}>
          ...
          >
            ...
            <Typography variant="h5" color="inherit" paragraph sx={{ fontFamily: 'Raleway' }}>
              Consult from the best doctors just by sitting at your home because we care for your health every moment
            </Typography>
          </Box>
        </Grid>
      </Grid>
